	...
	<div id="home">
		...
		<div class="content" ref="wrappers">
			<div class="content_small">
				...
				<div class="login">
					<p>密码</p> 
					<input class="input" placeholder="请输入密码" v-model="passwords" @change="handlepassFlag()" :type="active_tpye ? 'password' : 'text' "  style="width:90%"/>
			...
			<div class="logining" @click="submitForm">注册</div>
		</div>
	</div>
</template>
...
//							this.clock();
			...
			getarticlesInfo() {
				let url = '/app/3.0/customer/append';
				let data = {
					"mobile": this.phonename,
